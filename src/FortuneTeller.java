...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
	...
	static void begin() {
		...
		String Identity = JOptionPane.showInputDialog("What is your name user?");
		JOptionPane.showMessageDialog(null, "welcome " + Identity + " the secret location is by something tan");
	}
	...
	public void mousePressed(MouseEvent e) {
		...
		if (areClose(mouseX, secretLocationX) && areClose(mouseY, secretLocationY)) {
			...
			String question = JOptionPane.showInputDialog("What is your question Basic?");
