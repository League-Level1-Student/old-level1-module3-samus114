...
public class BookOfIllusions extends MouseAdapter implements ActionListener {
	JLabel label;
	JLabel label2;
	/*
	...
	//done
		...
		String th8 = "th[8].jpg";
		String lovelyImage = "lovely-image[1].jpg";
		// 6. create a variable of type "JLabel" but don't initialize it yet
	
		// 7. use the "loadImage..." methods below to initialize your JLabel
		label = loadImageFromComputer(th8);
		label2 = loadImageFromComputer(lovelyImage);
