...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		JPanel panel = createHeader("Memes");
	...
	public void actionPerformed(ActionEvent e) {
		...
		// Remove this temporary message after testing: did
		JButton buttonPressed = (JButton) e.getSource();
		// If the buttonPressed was the firstButton
		if (buttonPressed == firstButton) {
			// Call the askQuestion() method
			askQuestion("who was the MLG frog?", "dancing tie-dyed frog", 200);
			firstButton.setText("");
		}
...
askQuestion( "What was the NO U meme for?", "reversing things on the other person.", 400);
...
secondButton.setText("");
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		if (ans.equals(correctAnswer)) {
			...
			JOptionPane.showMessageDialog(null, "Congradulations you are correct.");
			// Otherwise
		} else {
			...
			// answer
			JOptionPane.showMessageDialog(null, "Thats wrong, the answer was" + correctAnswer);
		}
